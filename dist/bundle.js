...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__internal_io__ = __webpack_require__(5);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "takem", function() { return __WEBPACK_IMPORTED_MODULE_0__internal_io__["r"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__internal_io_helpers__ = __webpack_require__(47);
...
var _contractByName = __webpack_require__(22);

Object.defineProperty(exports, 'contractByName', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_contractByName).default;
  }
});

var _contractKeyByAddress = __webpack_require__(53);

Object.defineProperty(exports, 'contractKeyByAddress', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_contractKeyByAddress).default;
  }
});

var _cacheCallState = __webpack_require__(9);

Object.defineProperty(exports, 'cacheCallState', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_cacheCallState).default;
  }
});

var _cacheCallValue = __webpack_require__(55);

Object.defineProperty(exports, 'cacheCallValue', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_cacheCallValue).default;
  }
});

var _cacheCallValueInt = __webpack_require__(56);

Object.defineProperty(exports, 'cacheCallValueInt', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_cacheCallValueInt).default;
  }
});

var _cacheCallValueBigNumber = __webpack_require__(57);

Object.defineProperty(exports, 'cacheCallValueBigNumber', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_cacheCallValueBigNumber).default;
  }
});
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return takem; });
...
exports.getReadWeb3 = getReadWeb3;
exports.setReadWeb3 = setReadWeb3;
exports.web3NetworkId = web3NetworkId;
exports.web3Initialize = web3Initialize;

var _effects = __webpack_require__(1);

var _getWeb3OrNull = __webpack_require__(25);

var _getWeb3OrNull2 = _interopRequireDefault(_getWeb3OrNull);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _marked = /*#__PURE__*/_regenerator2.default.mark(getReadWeb3),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(setReadWeb3),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(web3NetworkId),
    _marked4 = /*#__PURE__*/_regenerator2.default.mark(web3Initialize);

function getReadWeb3() {
  var web3;
  return _regenerator2.default.wrap(function getReadWeb3$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _effects.getContext)('readWeb3');
        ...
        case 2:
          ...
          _context.next = 6;
          return (0, _effects.getContext)('web3');
...
function setReadWeb3(_ref) {
  var readWeb3 = _ref.readWeb3;
  return _regenerator2.default.wrap(function setReadWeb3$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _effects.setContext)('readWeb3', readWeb3);
...
function web3NetworkId() {
  var web3;
  return _regenerator2.default.wrap(function web3NetworkId$(_context3) {
    while (1) {
...
function web3Initialize() {
  var web3;
  return _regenerator2.default.wrap(function web3Initialize$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          web3 = (0, _getWeb3OrNull2.default)();
          ...
          _context4.next = 4;
          return (0, _effects.put)({ type: 'WEB3_INITIALIZED', web3: web3 });
        ...
        case 6:
          ...
          _context4.next = 9;
          return (0, _effects.put)({ type: 'WEB3_INITIALIZE_ERROR' });
...
exports.default = function (state, addressOrName, method) {
  if (addressOrName && !addressOrName.startsWith('0x')) {
    addressOrName = (0, _contractByName2.default)(state, addressOrName);
  }
  ...
  var hash = _hashCall2.default.apply(null, [addressOrName, method].concat(args));
  return state.sagaGenesis.callCache[hash] || {};
};

var _hashCall = __webpack_require__(12);

var _hashCall2 = _interopRequireDefault(_hashCall);

var _contractByName = __webpack_require__(22);

var _contractByName2 = _interopRequireDefault(_contractByName);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__buffers__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scheduler__ = __webpack_require__(50);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Call = function () {
  function Call(address, method) {
    ...
    this.args = args;
    this.hash = _hashCall2.default.apply(undefined, [address, method].concat(args));
  }

  _createClass(Call, [{
    key: 'toString',
    value: function toString(call) {
      return this.address + ': ' + this.method + '(' + this.args.map(function (a) {
        return a.toString();
      }).join(', ') + ')';
    }
  }]);
...
function createCall(address, method) {
  ...
  return new (Function.prototype.bind.apply(Call, [null].concat([address, method], args)))();
}
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(takeSequentially);

function takeSequentially(pattern, saga) {
  var channel, action;
  return _regenerator2.default.wrap(function takeSequentially$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _effects.actionChannel)(pattern, _reduxSaga.buffers.expanding(50));
        ...
        case 6:
          ...
          _context.next = 9;
          return (0, _effects.call)(saga, action);
...
var _cacheScopeSagas = __webpack_require__(21);

var _web3Sagas = __webpack_require__(7);

var _createCall = __webpack_require__(13);

var _stateFinders = __webpack_require__(3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

var _marked = /*#__PURE__*/_regenerator2.default.mark(isCacheActive),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(findResponse),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(waitForResponse),
    _marked4 = /*#__PURE__*/_regenerator2.default.mark(runCall),
    _marked5 = /*#__PURE__*/_regenerator2.default.mark(executeWeb3Call),
    _marked6 = /*#__PURE__*/_regenerator2.default.mark(cacheCall),
    _marked7 = /*#__PURE__*/_regenerator2.default.mark(cacheCallByName),
    _marked8 = /*#__PURE__*/_regenerator2.default.mark(cacheCallByAddress),
    _marked9 = /*#__PURE__*/_regenerator2.default.mark(callNoCache),
    _marked10 = /*#__PURE__*/_regenerator2.default.mark(web3Call),
    _marked11 = /*#__PURE__*/_regenerator2.default.mark(findWeb3Contract),
    _marked12 = /*#__PURE__*/_regenerator2.default.mark(findCallMethod),
    _marked13 = /*#__PURE__*/_regenerator2.default.mark(web3CallExecute),
    _marked14 = /*#__PURE__*/_regenerator2.default.mark(_callee2);

var debug = __webpack_require__(14)('call-cache-sagas');

var callsInFlight = new Set();

function isCacheActive(call) {
  var count;
  return _regenerator2.default.wrap(function isCacheActive$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _cacheScopeSagas.callCount)(call);
...
function findResponse(call) {
  var callState;
  return _regenerator2.default.wrap(function findResponse$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _effects.select)(function (state) {
            return state.sagaGenesis.callCache[call.hash];
          });
...
function waitForResponse(call) {
  var action;
  return _regenerator2.default.wrap(function waitForResponse$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          if (false) {
          ...
          _context3.next = 3;
          return (0, _effects.take)(['WEB3_CALL_RETURN', 'WEB3_CALL_ERROR']);
...
function runCall(call, cacheActive) {
  ...
  return _regenerator2.default.wrap(function runCall$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
...
function executeWeb3Call(call) {
  var inFlight;
  return _regenerator2.default.wrap(function executeWeb3Call$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 5;
          return (0, _effects.put)({ type: 'WEB3_CALL', call: call });
...
function cacheCall(addressOrName, method) {
  ...
  return _regenerator2.default.wrap(function cacheCall$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.next = 3;
          return cacheCallByAddress.apply(undefined, [addressOrName, method].concat(args));
        ...
        case 6:
          _context6.next = 8;
          return cacheCallByName.apply(undefined, [addressOrName, method].concat(args));
...
function cacheCallByName(name, method) {
  ...
  var address;
  return _regenerator2.default.wrap(function cacheCallByName$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return (0, _effects.select)(_stateFinders.contractByName, name);
        ...
        case 5:
          _context7.next = 7;
          return cacheCallByAddress.apply(undefined, [address, method].concat(args));
...
function cacheCallByAddress(address, method) {
  ...
  var call, cacheActive;
  return _regenerator2.default.wrap(function cacheCallByAddress$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          call = _createCall.createCall.apply(undefined, [address, method].concat(args));
          _context8.next = 3;
          return isCacheActive(call);
        ...
        case 3:
          ...
          _context8.next = 6;
          return (0, _cacheScopeSagas.registerCall)(call);

        case 6:
          _context8.next = 8;
          return runCall(call, cacheActive);
...
function callNoCache(address, method) {
  ...
  var call;
  return _regenerator2.default.wrap(function callNoCache$(_context9) {
    while (1) {
...
function web3Call(address, method) {
  ...
  var call;
  return _regenerator2.default.wrap(function web3Call$(_context10) {
    while (1) {
...
function findWeb3Contract(address) {
  ...
  return _regenerator2.default.wrap(function findWeb3Contract$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          _context11.next = 2;
          return (0, _effects.getContext)('readContractRegistry');

        case 2:
          contractRegistry = _context11.sent;
          _context11.next = 5;
          return (0, _web3Sagas.getReadWeb3)();

        case 5:
          web3 = _context11.sent;
          _context11.next = 8;
          return (0, _effects.select)(_stateFinders.contractKeyByAddress, address);
...
function findCallMethod(call) {
  ...
  return _regenerator2.default.wrap(function findCallMethod$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        case 0:
          address = call.address, method = call.method, args = call.args;
          _context12.next = 3;
        ...
        case 3:
          ...
          _context12.next = 8;
          return (0, _effects.put)({ type: 'WEB3_CALL_ERROR', call: call, error: 'Address ' + address + ' does not have method \'' + method + '\'' });

        case 8:
          return _context12.abrupt('return');

        case 9:
          return _context12.abrupt('return', contractMethod.apply(undefined, _toConsumableArray(args)).call);
...
function web3CallExecute(_ref) {
  var call = _ref.call;
  var account, options, callMethod;
  return _regenerator2.default.wrap(function web3CallExecute$(_context14) {
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 8:
          ...
          return (0, _effects.spawn)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var response;
            return _regenerator2.default.wrap(function _callee$(_context13) {
              while (1) {
                switch (_context13.prev = _context13.next) {
                  case 0:
                    _context13.prev = 0;
                    _context13.next = 3;
                    return (0, _effects.call)(callMethod, options);

                  case 3:
                    response = _context13.sent;
                    _context13.next = 6;
                    return (0, _effects.put)({ type: 'WEB3_CALL_RETURN', call: call, response: response });
                  ...
                  case 8:
                    ...
                    debug('web3CallExecute rpc ERROR: ' + _context13.t0);
                    _context13.next = 13;
                    return (0, _effects.put)({ type: 'WEB3_CALL_ERROR', call: call, error: _context13.t0 });

                  case 13:
                    console.error('Error on WEB3 Call: ', call.method, call.args, call, _context13.t0);
        ...
        case 13:
          ...
          debug('web3CallExecute general ERROR: ' + _context14.t0);
          _context14.next = 18;
        ...
        case 18:
          ...
          console.warn('Cancelled on WEB3 Call: ', call.method, call.args, call, _context14.t0);
          _context14.next = 22;
          return (0, _effects.put)({ type: 'WEB3_CALL_CANCELLED', call: call });
        ...
        case 24:
          console.error('Error on WEB3 Call: ', call.method, call.args, call, _context14.t0);
          _context14.next = 27;
          return (0, _effects.put)({ type: 'WEB3_CALL_ERROR', call: call, error: _context14.t0 });
...
function _callee2() {
  return _regenerator2.default.wrap(function _callee2$(_context15) {
    while (1) {
      switch (_context15.prev = _context15.next) {
        case 0:
          _context15.next = 2;
          return (0, _effects.takeEvery)('WEB3_CALL', web3CallExecute);
...
exports.deregisterKey = deregisterKey;
exports.registerCall = registerCall;
exports.callCount = callCount;
exports.invalidateAddress = invalidateAddress;
exports.invalidateTransaction = invalidateTransaction;
...
var _callCacheSagas = __webpack_require__(19);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _marked = /*#__PURE__*/_regenerator2.default.mark(deregisterKey),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(registerCall),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(callCount),
    _marked4 = /*#__PURE__*/_regenerator2.default.mark(invalidateAddress),
    _marked5 = /*#__PURE__*/_regenerator2.default.mark(invalidateTransaction),
    _marked6 = /*#__PURE__*/_regenerator2.default.mark(runSaga),
    _marked7 = /*#__PURE__*/_regenerator2.default.mark(prepareSaga),
    _marked8 = /*#__PURE__*/_regenerator2.default.mark(_callee3);

function deregisterKey(key) {
  var callCountRegistry, calls;
  return _regenerator2.default.wrap(function deregisterKey$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _effects.getContext)('callCountRegistry');
        ...
        case 2:
          ...
          _context.next = 7;
          return (0, _effects.put)({ type: 'WEB3_STALE_CALLS', calls: calls });
...
function registerCall(call) {
  ...
  return _regenerator2.default.wrap(function registerCall$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _effects.getContext)('key');
...
function callCount(call) {
  ...
  return _regenerator2.default.wrap(function callCount$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
...
function invalidateAddress(_ref) {
  ...
  var callCountRegistry, contractCalls;
  return _regenerator2.default.wrap(function invalidateAddress$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
        ...
        case 6:
          _context5.next = 8;
          return (0, _effects.all)(contractCalls.map( /*#__PURE__*/_regenerator2.default.mark(function _callee(callState) {
            var call;
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    call = callState.call;
                    _context4.next = 4;
                    return (0, _callCacheSagas.executeWeb3Call)(call);
...
function invalidateTransaction(_ref2) {
  ...
  return _regenerator2.default.wrap(function invalidateTransaction$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          ...
          _context7.next = 4;
          return (0, _effects.all)(Array.from(contractAddresses).map( /*#__PURE__*/_regenerator2.default.mark(function _callee2(address) {
            var contractKey;
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    ...
                    _context6.next = 6;
                    return (0, _effects.fork)(_effects.put, { type: 'CACHE_INVALIDATE_ADDRESS', address: address });
...
function runSaga(_ref3) {
  var saga = _ref3.saga,
      props = _ref3.props,
      key = _ref3.key;
  var callCountRegistry, oldCalls, emptyCalls;
  return _regenerator2.default.wrap(function runSaga$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          _context8.prev = 0;
          _context8.next = 3;
          return (0, _effects.setContext)({ key: key });
        ...
        case 5:
          ...
          _context8.next = 9;
          return (0, _effects.call)(saga, props);
        ...
        case 9:
          ...
          _context8.next = 13;
          return (0, _effects.put)({ type: 'WEB3_STALE_CALLS', calls: emptyCalls });
        ...
        case 23:
          _context8.next = 25;
          return (0, _effects.put)({ type: 'SAGA_CANCELLED', key: key });
...
function prepareSaga(_ref4) {
  var saga = _ref4.saga,
      ...
      key = _ref4.key;
  var action, task;
  return _regenerator2.default.wrap(function prepareSaga$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          action = 'RUN_SAGA_' + key;
          _context9.next = 3;
          return (0, _effects.takeLatest)(action, runSaga);

        case 3:
          task = _context9.sent;
          _context9.next = 6;
          return runSaga({ saga: saga, props: props, key: key });

        case 6:
          _context9.next = 8;
          return (0, _effects.take)('END_SAGA_' + key);
...
function _callee3() {
  return _regenerator2.default.wrap(function _callee3$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
          _context10.next = 2;
          return (0, _effects.takeEvery)('TRANSACTION_CONFIRMED', invalidateTransaction);

        case 2:
          _context10.next = 4;
          return (0, _effects.takeEvery)('CACHE_INVALIDATE_ADDRESS', invalidateAddress);

        case 4:
          _context10.next = 6;
          return (0, _effects.takeEvery)('PREPARE_SAGA', prepareSaga);
...
exports.default = function (state, name) {
...
var _getWeb = __webpack_require__(54);
...
exports.default = function () {
  if (!_web3 && window && window.web3) {
    _web3 = new _web2.default(window.web3.currentProvider);
  }
  return _web3;
};
...
/* WEBPACK VAR INJECTION */(function(module) {(function (module, exports) {
  ...
  var Buffer;
  try {
    Buffer = __webpack_require__(59).Buffer;
  } catch (e) {
  }
...
var _callCountRegistry = __webpack_require__(31);

Object.defineProperty(exports, 'CallCountRegistry', {
  enumerable: true,
  get: function get() {
    return _callCountRegistry.CallCountRegistry;
  }
});

var _contractRegistry = __webpack_require__(32);

Object.defineProperty(exports, 'ContractRegistry', {
  enumerable: true,
  get: function get() {
    return _contractRegistry.ContractRegistry;
  }
});
...
Object.keys(_stateFinders).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _stateFinders[key];
    }
  });
});
...
var _TransactionStateHandler = __webpack_require__(78);

Object.defineProperty(exports, 'TransactionStateHandler', {
  enumerable: true,
  get: function get() {
    return _TransactionStateHandler.TransactionStateHandler;
  }
});

var _transactionFactory = __webpack_require__(27);

Object.defineProperty(exports, 'nextId', {
  enumerable: true,
  get: function get() {
    return _transactionFactory.nextId;
  }
});

var _logReducerFactory = __webpack_require__(79);

Object.keys(_logReducerFactory).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _logReducerFactory[key];
    }
  });
});
...
var CallCountRegistry = exports.CallCountRegistry = function () {
...
var ContractRegistry = exports.ContractRegistry = function () {
...
var _accountReducer = __webpack_require__(35);

var _accountReducer2 = _interopRequireDefault(_accountReducer);

var _contractReducer = __webpack_require__(36);

var _contractReducer2 = _interopRequireDefault(_contractReducer);

var _callCacheReducer = __webpack_require__(37);

var _callCacheReducer2 = _interopRequireDefault(_callCacheReducer);

var _transactionReducer = __webpack_require__(38);

var _transactionReducer2 = _interopRequireDefault(_transactionReducer);

var _ethBalanceReducer = __webpack_require__(39);

var _ethBalanceReducer2 = _interopRequireDefault(_ethBalanceReducer);

var _networkReducer = __webpack_require__(40);

var _networkReducer2 = _interopRequireDefault(_networkReducer);

var _web3Reducer = __webpack_require__(41);

var _web3Reducer2 = _interopRequireDefault(_web3Reducer);

var _logReducer = __webpack_require__(42);

var _logReducer2 = _interopRequireDefault(_logReducer);

var _blockReducer = __webpack_require__(43);
...
var reducers = exports.reducers = (0, _redux.combineReducers)({
  callCache: _callCacheReducer2.default,
  accounts: _accountReducer2.default,
  transactions: _transactionReducer2.default,
  network: _networkReducer2.default,
  ethBalance: _ethBalanceReducer2.default,
  contracts: _contractReducer2.default,
  web3: _web3Reducer2.default,
  logs: _logReducer2.default,
...
exports.default = function (state, _ref) {
  ...
  switch (type) {
    case 'ADD_CONTRACT':
      ...
      state = {
        networks: Object.assign({}, state.networks, _defineProperty({}, networkId, Object.assign({}, networkConfig, {
          addressContractKey: Object.assign({}, networkConfig.addressContractKey, _defineProperty({}, address, contractKey))
        })))
      };
      ...
      if (name) {
        state = {
          networks: Object.assign({}, state.networks, _defineProperty({}, networkId, Object.assign({}, networkConfig, {
            nameAddress: Object.assign({}, networkConfig.nameAddress, _defineProperty({}, name, address))
          })))
        };
      }
      break;
...
exports.default = function (state, _ref) {
  ...
  switch (type) {
    ...
    case 'WEB3_CALL':
      state = Object.assign({}, state, _defineProperty({}, call.hash, Object.assign({}, state[call.hash], {
        inFlight: true,
        stale: false
      })));
      break;
...
exports.default = function (state, _ref) {
  ...
  switch (type) {
    case 'SEND_TRANSACTION':
      state = Object.assign({}, state, _defineProperty({}, transactionId, {
    ...
    case 'TRANSACTION_HASH':
      state = Object.assign({}, state, _defineProperty({}, transactionId, Object.assign({}, state[transactionId], {
        call: call,
        inFlight: false,
        submitted: true,
        txHash: txHash
...
exports.default = function (state, _ref) {
  ...
  switch (type) {
    case 'LOG_LISTENER_ADDED':
      if (!state[address]) {
        state = Object.assign({}, state, _defineProperty({}, address, {
          count: 1
        }));
      } else {
        state = Object.assign({}, state, _defineProperty({}, address, Object.assign({}, state[address], {
...
exports.takeSequentially = exports.takeOnceAndRun = exports.web3NetworkId = exports.addContract = exports.web3Send = undefined;
...
Object.keys(_callCacheSagas).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _callCacheSagas[key];
    }
  });
});
exports.start = start;
...
var _accountSagas = __webpack_require__(60);

var _accountSagas2 = _interopRequireDefault(_accountSagas);

var _contractSagas = __webpack_require__(61);

var _blockSagas = __webpack_require__(62);

var _blockSagas2 = _interopRequireDefault(_blockSagas);

var _cacheScopeSagas = __webpack_require__(21);

var _cacheScopeSagas2 = _interopRequireDefault(_cacheScopeSagas);

var _callCacheSagas2 = _interopRequireDefault(_callCacheSagas);

var _networkSagas = __webpack_require__(63);

var _networkSagas2 = _interopRequireDefault(_networkSagas);

var _ethBalanceSagas = __webpack_require__(64);

var _ethBalanceSagas2 = _interopRequireDefault(_ethBalanceSagas);

var _transactionSagas = __webpack_require__(65);

var _transactionSagas2 = _interopRequireDefault(_transactionSagas);

var _web3Sagas = __webpack_require__(7);

var _logSaga = __webpack_require__(66);

var _takeOnceAndRun = __webpack_require__(67);

var _takeSequentially = __webpack_require__(15);
  ...
  return _regenerator2.default.wrap(function start$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _effects.setContext)({ web3: web3 });

        case 2:
          _context.next = 4;
          return (0, _effects.all)([(0, _callCacheSagas2.default)(), (0, _networkSagas2.default)(), (0, _accountSagas2.default)(), (0, _blockSagas2.default)(), (0, _cacheScopeSagas2.default)(), (0, _transactionSagas2.default)(), (0, _ethBalanceSagas2.default)(), (0, _logSaga.logSaga)()]);
...
exports.web3Send = _transactionSagas.web3Send;
exports.addContract = _contractSagas.addContract;
exports.web3NetworkId = _web3Sagas.web3NetworkId;
exports.takeOnceAndRun = _takeOnceAndRun.takeOnceAndRun;
exports.takeSequentially = _takeSequentially.takeSequentially;
function _callee() {
  return _regenerator2.default.wrap(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _effects.fork)(_takeOnceAndRun.takeOnceAndRun, 'WEB3_INITIALIZED', start);

        case 2:
          _context2.next = 4;
          return (0, _web3Sagas.web3Initialize)();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__io__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sagaHelpers__ = __webpack_require__(48);
...
function takeEvery(patternOrChannel, worker) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0__io__["i" /* fork */].apply(undefined, [__WEBPACK_IMPORTED_MODULE_1__sagaHelpers__["a" /* takeEveryHelper */], patternOrChannel, worker].concat(args));
}
...
function takeLatest(patternOrChannel, worker) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0__io__["i" /* fork */].apply(undefined, [__WEBPACK_IMPORTED_MODULE_1__sagaHelpers__["b" /* takeLatestHelper */], patternOrChannel, worker].concat(args));
}
...
function throttle(ms, pattern, worker) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0__io__["i" /* fork */].apply(undefined, [__WEBPACK_IMPORTED_MODULE_1__sagaHelpers__["c" /* throttleHelper */], ms, pattern, worker].concat(args));
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__takeEvery__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__takeLatest__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__throttle__ = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__io__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__io__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__channel__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__buffers__ = __webpack_require__(20);
...
exports.default = function (state, address) {
  if (!address) {
    return;
  }
  address = address.toLowerCase();
...
exports.default = function () {
  if (!_web3) {
    _web3 = (0, _getWeb3OrNull2.default)();
  }
  if (!_web3) {
    _web3 = new _web2.default();
  }
  return _web3;
};
...
exports.default = function (state, address, method) {
  for (var _len = arguments.length, args = Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
    args[_key - 3] = arguments[_key];
  }

  var callState = _cacheCallState2.default.apply(undefined, [state, address, method].concat(args));
  if (callState) return callState.response;
};

var _cacheCallState = __webpack_require__(9);

var _cacheCallState2 = _interopRequireDefault(_cacheCallState);
...
exports.default = function (state, address, method) {
  ...
  var response = callState.response;
  if (response) {
    var bigNum = new _bn2.default(response);
  }
  return bigNum;
};

var _bn = __webpack_require__(26);
...
exports.startAccountsPolling = startAccountsPolling;
exports.default = _callee;
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(refreshAccounts),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(startAccountsPolling),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(_callee);

function refreshAccounts() {
  var web3, existingAccount, accounts;
  return _regenerator2.default.wrap(function refreshAccounts$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 9:
          ...
          _context.next = 13;
          return (0, _effects.put)({ type: 'WEB3_ACCOUNTS', accounts: accounts });
        ...
        case 15:
          ...
          _context.next = 19;
          return (0, _effects.put)({ type: 'SAGA_GENESIS_CAUGHT_ERROR', error: _context.t0 });
...
function startAccountsPolling() {
  return _regenerator2.default.wrap(function startAccountsPolling$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          if (false) {
          ...
          _context2.next = 3;
          return (0, _effects.call)(refreshAccounts);
  ...
  return _regenerator2.default.wrap(function _callee$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _effects.fork)(startAccountsPolling);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          _context.next = 12;
          return (0, _effects.put)({ type: "ADD_CONTRACT", address: address, name: name, contractKey: contractKey, networkId: networkId });
...
exports.addAddressIfExists = addAddressIfExists;
exports.getReceiptData = getReceiptData;
exports.invalidateAddressSet = invalidateAddressSet;
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(addAddressIfExists),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(getReceiptData),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(transactionReceipt),
    _marked4 = /*#__PURE__*/_regenerator2.default.mark(invalidateAddressSet),
    _marked5 = /*#__PURE__*/_regenerator2.default.mark(latestBlock),
    _marked6 = /*#__PURE__*/_regenerator2.default.mark(updateCurrentBlockNumber),
    _marked7 = /*#__PURE__*/_regenerator2.default.mark(gatherLatestBlocks),
    _marked8 = /*#__PURE__*/_regenerator2.default.mark(getBlockData),
    _marked9 = /*#__PURE__*/_regenerator2.default.mark(startBlockPolling),
    _marked10 = /*#__PURE__*/_regenerator2.default.mark(_callee4);

var debug = __webpack_require__(14)('block-sagas');

var MAX_RETRIES = 50;

function addAddressIfExists(addressSet, address) {
  var contractKey;
  return _regenerator2.default.wrap(function addAddressIfExists$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          if (address) {
...
function getReceiptData(txHash) {
  var web3, i, receipt;
  return _regenerator2.default.wrap(function getReceiptData$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
        ...
        case 4:
          ...
          _context2.next = 7;
          return (0, _effects.call)(web3.eth.getTransactionReceipt, txHash);
...
function transactionReceipt(_ref) {
  ...
  var addressSet;
  return _regenerator2.default.wrap(function transactionReceipt$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          addressSet = new Set();
          _context5.next = 4;
          return (0, _effects.all)(receipt.logs.map( /*#__PURE__*/_regenerator2.default.mark(function _callee2(log) {
            return _regenerator2.default.wrap(function _callee2$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.next = 2;
                    return (0, _effects.call)(addAddressIfExists, addressSet, log.address);
                  ...
                  case 2:
                    ...
                    _context4.next = 5;
                    return (0, _effects.all)(log.topics.map( /*#__PURE__*/_regenerator2.default.mark(function _callee(topic) {
                      var actualAddress;
                      return _regenerator2.default.wrap(function _callee$(_context3) {
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            case 0:
                              ...
                              _context3.next = 4;
                              return (0, _effects.call)(addAddressIfExists, addressSet, actualAddress);
...
function invalidateAddressSet(addressSet) {
  return _regenerator2.default.wrap(function invalidateAddressSet$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _context7.next = 2;
          return (0, _effects.all)(Array.from(addressSet).map( /*#__PURE__*/_regenerator2.default.mark(function _callee3(address) {
...
function latestBlock(_ref2) {
  ...
  var addressSet, i, transaction, to, from, receipt;
  return _regenerator2.default.wrap(function latestBlock$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          ...
          _context8.prev = 1;
          addressSet = new Set();
          _context8.t0 = _regenerator2.default.keys(block.transactions);
        ...
        case 4:
          ...
          _context8.next = 9;
          return (0, _effects.call)(addAddressIfExists, addressSet, transaction.to);

        case 9:
          to = _context8.sent;
          _context8.next = 12;
          return (0, _effects.call)(addAddressIfExists, addressSet, transaction.from);
        ...
        case 12:
          ...
          _context8.next = 16;
          return (0, _effects.call)(getReceiptData, transaction.hash);

        case 16:
          receipt = _context8.sent;
          _context8.next = 19;
          return (0, _effects.put)({ type: 'BLOCK_TRANSACTION_RECEIPT', receipt: receipt });
        ...
        case 21:
          _context8.next = 23;
          return (0, _effects.call)(invalidateAddressSet, addressSet);
        ...
        case 25:
          ...
          _context8.next = 29;
          return (0, _effects.put)({ type: 'SAGA_GENESIS_CAUGHT_ERROR', error: _context8.t2 });
...
function updateCurrentBlockNumber() {
  ...
  return _regenerator2.default.wrap(function updateCurrentBlockNumber$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          _context9.prev = 0;
        ...
        case 3:
          web3 = _context9.sent;
          _context9.next = 6;
          return (0, _effects.call)(web3.eth.getBlockNumber);
...
function gatherLatestBlocks(_ref3) {
  var blockNumber = _ref3.blockNumber,
      lastBlockNumber = _ref3.lastBlockNumber;
  var i, block;
  return _regenerator2.default.wrap(function gatherLatestBlocks$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
        ...
        case 5:
          ...
          _context10.next = 8;
          return (0, _effects.call)(getBlockData, i);

        case 8:
          block = _context10.sent;
          _context10.next = 11;
          return (0, _effects.put)({ type: 'BLOCK_LATEST', block: block });
        ...
        case 16:
          ...
          _context10.next = 20;
          return (0, _effects.put)({ type: 'SAGA_GENESIS_CAUGHT_ERROR', error: _context10.t0 });
...
function getBlockData(blockId) {
  var web3, i, block;
  return _regenerator2.default.wrap(function getBlockData$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        case 0:
          _context11.next = 2;
        ...
        case 4:
          ...
          _context11.next = 7;
          return (0, _effects.call)(web3.eth.getBlock, blockId, true);
...
function startBlockPolling() {
  return _regenerator2.default.wrap(function startBlockPolling$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        case 0:
          if (false) {
          ...
          _context12.prev = 1;
          _context12.next = 4;
          return (0, _effects.call)(updateCurrentBlockNumber);
        ...
        case 6:
          ...
          _context12.next = 10;
          return (0, _effects.put)({ type: 'SAGA_GENESIS_CAUGHT_ERROR', error: _context12.t0 });
...
function _callee4() {
  return _regenerator2.default.wrap(function _callee4$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        case 0:
          _context13.next = 2;
          return (0, _effects.fork)(_takeSequentially.takeSequentially, 'BLOCK_LATEST', latestBlock);

        case 2:
          _context13.next = 4;
          return (0, _effects.fork)(_takeSequentially.takeSequentially, 'BLOCK_TRANSACTION_RECEIPT', transactionReceipt);

        case 4:
          _context13.next = 6;
          return (0, _effects.fork)(_takeSequentially.takeSequentially, 'UPDATE_BLOCK_NUMBER', gatherLatestBlocks);

        case 6:
          _context13.next = 8;
          return (0, _effects.fork)(startBlockPolling);
...
exports.refreshNetwork = refreshNetwork;
exports.startNetworkPolling = startNetworkPolling;
exports.default = _callee;
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(refreshNetwork),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(startNetworkPolling),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(_callee);

function refreshNetwork() {
  var web3, existingNetworkId, networkId;
  return _regenerator2.default.wrap(function refreshNetwork$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
        ...
        case 9:
          ...
          _context.next = 13;
          return (0, _effects.put)({ type: 'WEB3_NETWORK_ID', web3: web3, networkId: networkId });
...
function startNetworkPolling() {
  return _regenerator2.default.wrap(function startNetworkPolling$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          if (false) {
          ...
          _context2.next = 3;
          return (0, _effects.call)(refreshNetwork);
  ...
  return _regenerator2.default.wrap(function _callee$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _effects.fork)(startNetworkPolling);
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(getEthBalance),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(startEthBalancePolling),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(_callee);

function getEthBalance() {
  var web3, address, balance, oldBalance;
  return _regenerator2.default.wrap(function getEthBalance$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
        ...
        case 8:
          _context.next = 10;
          return (0, _effects.call)(web3.eth.getBalance, address);
        ...
        case 13:
          ...
          _context.next = 17;
          return (0, _effects.put)({ type: 'ETH_BALANCE', balance: balance });
...
function startEthBalancePolling() {
  return _regenerator2.default.wrap(function startEthBalancePolling$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          if (false) {
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return (0, _effects.call)(getEthBalance);
        ...
        case 6:
          ...
          _context2.next = 10;
          return (0, _effects.put)({ type: 'SAGA_GENESIS_CAUGHT_ERROR', error: _context2.t0 });
  ...
  return _regenerator2.default.wrap(function _callee$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _effects.fork)(startEthBalancePolling);
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(web3Send),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(_callee);

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

var debug = __webpack_require__(14)('transaction-sagas');
...
function createTransactionEventChannel(web3, call, transactionId, send, options) {
  ...
  return (0, _reduxSaga.eventChannel)(function (emit) {
    var promiEvent = send(options).on('transactionHash', function (txHash) {
      ...
      emit({ type: 'TRANSACTION_HASH', transactionId: transactionId, txHash: txHash, call: call });
    }).on('confirmation', function (confirmationNumber, receipt) {
      debug('#' + transactionId + ': confirmation ' + confirmationNumber);
      emit({ type: 'TRANSACTION_CONFIRMATION', transactionId: transactionId, confirmationNumber: confirmationNumber, receipt: receipt });
      if (confirmationNumber > 2) {
        emit({ type: 'TRANSACTION_CONFIRMED', transactionId: transactionId, call: call, confirmationNumber: confirmationNumber, receipt: receipt });
        emit(_reduxSaga.END);
      }
    }).on('receipt', function (receipt) {
      debug('#' + transactionId + ': receipt', receipt);
      emit({ type: 'TRANSACTION_RECEIPT', transactionId: transactionId, receipt: receipt });
    }).on('error', function (error) {
      debug('#' + transactionId + ': error ' + error);

      var txObject = { type: 'TRANSACTION_ERROR', transactionId: transactionId, call: call, error: error.toString() };
...
function web3Send(_ref) {
  var transactionId = _ref.transactionId,
      call = _ref.call,
      options = _ref.options;
  var address, method, args, account, contractRegistry, web3, contractKey, contract, contractMethod, func, send, transactionChannel;
  return _regenerator2.default.wrap(function web3Send$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
        ...
        case 5:
          ...
          _context.next = 9;
          return (0, _effects.getContext)('writeContractRegistry');
        ...
        case 15:
          ...
          _context.next = 21;
          return (0, _effects.put)({ type: 'TRANSACTION_ERROR', transactionId: transactionId, call: call, error: 'Address ' + address + ' does not have method \'' + method + '\'' });

        case 21:
          return _context.abrupt('return');

        case 22:
          func = contractMethod.apply(undefined, _toConsumableArray(args));
          send = func.send;
          transactionChannel = createTransactionEventChannel(web3, call, transactionId, send, options);
          _context.prev = 25;
        ...
        case 26:
          ...
          _context.t0 = _effects.put;
          _context.next = 30;
          return (0, _effects.take)(transactionChannel);
        ...
        case 40:
          ...
          _context.next = 45;
          return (0, _effects.put)({ type: 'TRANSACTION_ERROR', transactionId: transactionId, call: call, error: _context.t2.message });
  ...
  return _regenerator2.default.wrap(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return (0, _effects.takeEvery)('SEND_TRANSACTION', web3Send);
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(addSubscription),
    _marked2 = /*#__PURE__*/_regenerator2.default.mark(checkReceiptForEvents),
    _marked3 = /*#__PURE__*/_regenerator2.default.mark(logSaga);

function addSubscription(_ref) {
  var address = _ref.address,
      fromBlock = _ref.fromBlock;
  var listener, web3, fromBlockHex, pastLogs;
  return _regenerator2.default.wrap(function addSubscription$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          address = address.toLowerCase();
          _context.next = 3;
          return (0, _effects.put)({ type: 'LOG_LISTENER_ADDED', address: address });
        ...
        case 9:
          ...
          _context.next = 13;
          return (0, _effects.call)([web3.eth, 'getPastLogs'], { fromBlock: fromBlockHex, toBlock: 'latest', address: address });

        case 13:
          pastLogs = _context.sent;
          _context.next = 16;
          return (0, _effects.put)({ type: 'PAST_LOGS', address: address, logs: pastLogs });
...
function checkReceiptForEvents(_ref2) {
  var receipt = _ref2.receipt;
  return _regenerator2.default.wrap(function checkReceiptForEvents$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _effects.all)(receipt.logs.map( /*#__PURE__*/_regenerator2.default.mark(function _callee(log) {
            var address, logs;
            return _regenerator2.default.wrap(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    ...
                    _context2.next = 7;
                    return (0, _effects.put)({ type: 'NEW_LOG', address: address, log: log });
...
function logSaga() {
  return _regenerator2.default.wrap(function logSaga$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return (0, _effects.fork)(_takeSequentially.takeSequentially, 'ADD_LOG_LISTENER', addSubscription);

        case 2:
          _context4.next = 4;
          return (0, _effects.fork)(_takeSequentially.takeSequentially, 'BLOCK_TRANSACTION_RECEIPT', checkReceiptForEvents);
...
var _marked = /*#__PURE__*/_regenerator2.default.mark(takeOnceAndRun);

function takeOnceAndRun(pattern, saga) {
  var action;
  return _regenerator2.default.wrap(function takeOnceAndRun$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
...
var _contractRegistryProvider = __webpack_require__(69);

Object.defineProperty(exports, 'ContractRegistryProvider', {
  enumerable: true,
  get: function get() {
    return _contractRegistryProvider.ContractRegistryProvider;
  }
});

var _withContractRegistry = __webpack_require__(74);

Object.defineProperty(exports, 'withContractRegistry', {
  enumerable: true,
  get: function get() {
    return _withContractRegistry.withContractRegistry;
  }
});

var _withSaga = __webpack_require__(75);

Object.defineProperty(exports, 'withSaga', {
  enumerable: true,
  get: function get() {
    return _withSaga.withSaga;
  }
});

var _withSend = __webpack_require__(76);

Object.defineProperty(exports, 'withSend', {
  enumerable: true,
  get: function get() {
    return _withSend.withSend;
  }
});

var _LogListener = __webpack_require__(77);

Object.defineProperty(exports, 'LogListener', {
  enumerable: true,
  get: function get() {
    return _LogListener.LogListener;
  }
});
...
exports.ContractRegistryProvider = undefined;
...
var ContractRegistryProvider = exports.ContractRegistryProvider = function (_React$Component) {
  ...
  function ContractRegistryProvider() {
    ...
    return _possibleConstructorReturn(this, (ContractRegistryProvider.__proto__ || Object.getPrototypeOf(ContractRegistryProvider)).apply(this, arguments));
  }
...
ContractRegistryProvider.propTypes = {
  contractRegistry: _propTypes2.default.object.isRequired
};
ContractRegistryProvider.childContextTypes = {
  contractRegistry: _propTypes2.default.object
};
...
var _jsxFileName = '/Users/chuckbergeron/Git/crypto/saga-genesis/src/components/with-contract-registry.js';
...
function withContractRegistry(WrappedComponent) {
  ...
  var ContractRegistryWrapper = (_temp = _class = function (_Component) {
    ...
    function _ContractRegistryWrapper() {
      ...
      return _possibleConstructorReturn(this, (_ContractRegistryWrapper.__proto__ || Object.getPrototypeOf(_ContractRegistryWrapper)).apply(this, arguments));
    }

    _createClass(_ContractRegistryWrapper, [{
      key: 'render',
      value: function render() {
        return _react2.default.createElement(WrappedComponent, _extends({}, this.props, { contractRegistry: this.context.contractRegistry, __source: {
...
var _jsxFileName = '/Users/chuckbergeron/Git/crypto/saga-genesis/src/components/with-saga.js';
    ...
    function mapDispatchToProps(dispatch, props) {
      return {
        dispatchPrepareSaga: function dispatchPrepareSaga(props, key) {
          dispatch({ type: 'PREPARE_SAGA', saga: saga, key: key, props: props });
        },

        dispatchRunSaga: function dispatchRunSaga(props, key, displayName) {
          dispatch({ type: 'RUN_SAGA_' + key, saga: saga, props: props, key: key, displayName: displayName });
        },

        dispatchEndSaga: function dispatchEndSaga(key) {
          dispatch({ type: 'END_SAGA_' + key, key: key });
        }
      };
    }

    var SagaWrapper = (0, _reactRedux.connect)(function () {
      return {};
    }, mapDispatchToProps)(function (_PureComponent) {
      _inherits(_SagaWrapper, _PureComponent);

      function _SagaWrapper(props, context) {
        _classCallCheck(this, _SagaWrapper);

        var _this = _possibleConstructorReturn(this, (_SagaWrapper.__proto__ || Object.getPrototypeOf(_SagaWrapper)).call(this, props, context));

        _this.displayName = 'WithSaga(' + getDisplayName(WrappedComponent) + ')';
      ...
      _createClass(_SagaWrapper, [{
        ...
        key: 'render',
        value: function render() {
          return _react2.default.createElement(WrappedComponent, _extends({}, this.props, { sagaKey: this.sagaKey, __source: {
              fileName: _jsxFileName,
              lineNumber: 50
            },
            __self: this
...
var _jsxFileName = '/Users/chuckbergeron/Git/crypto/saga-genesis/src/components/with-send.js';
  ...
  function mapDispatchToProps(dispatch, props) {
    return {
      dispatchSend: function dispatchSend(transactionId, call, address, options) {
        dispatch({ type: 'SEND_TRANSACTION', transactionId: transactionId, call: call, address: address, options: options });
      }
    };
  }

  var SendWrapper = (0, _reactRedux.connect)(function () {
    return {};
  }, mapDispatchToProps)((_temp2 = _class = function (_Component) {
    ...
    function _SendWrapper() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _SendWrapper.__proto__ || Object.getPrototypeOf(_SendWrapper)).call.apply(_ref, [this].concat(args))), _this), _initialiseProps.call(_this), _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(_SendWrapper, [{
      key: 'render',
      value: function render() {
        return _react2.default.createElement(WrappedComponent, _extends({}, this.props, { send: this.send, __source: {
            fileName: _jsxFileName,
            lineNumber: 26
          },
          __self: this
    ...
    this.send = function (address, method) {
      for (var _len2 = arguments.length, args = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
        args[_key2 - 2] = arguments[_key2];
      }

      return function (options) {
        var call = _createCall.createCall.apply(undefined, [address, method].concat(args));
        var transactionId = (0, _transactionFactory.nextId)();
        _this2.props.dispatchSend(transactionId, call, address, options);
...
exports.LogListener = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _class,
    _temp,
    _jsxFileName = '/Users/chuckbergeron/Git/crypto/saga-genesis/src/components/LogListener.js';
...
function mapDispatchToProps(dispatch) {
  return {
    dispatchAddLogListener: function dispatchAddLogListener(address, fromBlock) {
      dispatch((0, _actions.addLogListener)(address, fromBlock));
    },

    dispatchRemoveLogListener: function dispatchRemoveLogListener(address) {
      dispatch((0, _actions.removeLogListener)(address));
    }
  };
}
...
var LogListener = exports.LogListener = (0, _reactRedux.connect)(function () {
  return {};
  ...
  function _LogListener() {
    ...
    return _possibleConstructorReturn(this, (_LogListener.__proto__ || Object.getPrototypeOf(_LogListener)).apply(this, arguments));
  }
  ...
  fromBlock: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.instanceOf(_bn2.default)])
}, _temp));
...
var TransactionStateHandler = exports.TransactionStateHandler = function () {
...
var _abiFactory = __webpack_require__(81);

Object.keys(_abiFactory).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _abiFactory[key];
    }
  });
});
...
Object.keys(_createCall).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _createCall[key];
    }
  });
});
...
Object.defineProperty(exports, 'hashCall', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_hashCall).default;
  }
});

var _ABIHelper = __webpack_require__(82);

Object.keys(_ABIHelper).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _ABIHelper[key];
    }
  });
});
...
exports.ABIHelper = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _sha = __webpack_require__(23);

var _ethjsAbi = __webpack_require__(83);
...
var ABIHelper = exports.ABIHelper = function () {
  function ABIHelper(abi) {
    var _this = this;
    ...
    this._lookup = {};
    this._topic0Lookup = {};
    abi.forEach(function (definition) {
  ...
  _createClass(ABIHelper, [{
    ...
    value: function topic0(nameOrDefinition) {
      ...
      return (0, _sha.sha3)(definition.name + '(' + types.join(',') + ')');
    }
  }, {
    key: 'decodeLogParameters',
    value: function decodeLogParameters(log) {
      var definition = this._topic0Lookup[log.topics[0]];
      return _ethjsAbi2.default.decodeEvent(definition, log.data, log.topics);
    }
  }]);
